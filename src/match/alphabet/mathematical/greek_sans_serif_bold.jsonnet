...
local PRE = g.PRE_GREEK_SANS_SERIF_BOLD;
local POST = g.POST_GREEK_SANS_SERIF_BOLD;

local STYLES = g.compositeStringArrayOuterProduct(g.STYLES_GREEK_SANS_SERIF_BOLD);
